...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'master/produk', component: () => import('pages/MasterProduk.vue'), meta: {role: ['admin','kasir']} },
      { path: 'master/bahan', component: () => import('pages/MasterBahan.vue'), meta: {role: ['admin','bakery']} },
      { path: 'master/komposisi', component: () => import('pages/MasterKomposisi.vue'), meta: {role: ['admin','bakery']} },
